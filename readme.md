...
## Recursos
- Sistema de rotas simples e intuitivo
- Integração com banco de dados
- Validações de formulários

# Aprendizado

A documentação foi criada pensando em iniciantes. Além das explicações técnicas, diversas partes do código possuem comentários detalhados que ajudam a entender o motivo de cada implementação.

O objetivo não é apenas fazer funcionar, mas ensinar como funciona.

## Primeiros Passos
```bash
git clone https://github.com/silvaleal/php-pure pure-app
cd pure-app
```
